...
Record=AFF_train.inverseE_new( task,trained_model,E_target,ind_initial=initial,tol_MAE=0.01,lr=1e-2,c=0.8,num_step = 5,random_val = 1e-2)
...
while n_loop<5:
    ...
    Record=AFF_train.inverseE_new( task,trained_model,E_target,ind_initial=initial,tol_MAE=0.01,lr=1e-1,c=0.8,num_step = 30,random_val = 1e-2)
