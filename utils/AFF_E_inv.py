...
class AFFTrain(object):
    ...
    def inverseE(self, task,trained_model,E_target, ind_initial,tol_MAE, lr,c,num_step,random_noise = 1e-4,
            cprsn_callback=None,
            save_progr_callback=None,  # TODO: document me
            callback=None):
       ...
       #dim_i = 3 * n_atoms #36
        ...
        R_val_atom=task['R_train'][ind_initial,None] + (np.random.normal(size = n_atoms*3)*random_noise).reshape(1,-1,3)
