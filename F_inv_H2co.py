...
class GDMLTrain(object):
    ...
    def test(self, task,sig_optim,sig_candid1_opt,alphas_opt,kernel_time_ave,
            cprsn_callback=None,
            save_progr_callback=None,  # TODO: document me
            callback=None):
        task = dict(task)
...
# sig_opt,sig_opt_E,alphas_opt,kernel_time_ave = gdml_train.train(task,np.arange(1,20,2))#uracil
...
# np.save('task_uracil_Finv_h2co{}.npy', task) 

# np.save('sig_opt_F_h2co.npy', sig_opt) 

# np.save('alphas_opt_Fh2.npy', alphas_opt) 
