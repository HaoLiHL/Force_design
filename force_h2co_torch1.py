...
trained_model= AFF_train.train(task,np.arange(1,30,5),np.arange(0.1,1,0.1))
np.save('saved_model/task_h2co.npy', trained_model) 
...
#     Record=AFF_train.inverseE_new( task,trained_model,E_target,ind_initial=initial,tol_MAE=0.01,lr=1e-1,c=10,num_step = 30,random_val = 1e-2)
