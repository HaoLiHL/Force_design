...
# np.save('saved_model/task_sali200.npy', task) 
# np.save('saved_model/trained_model_sali200.npy', trained_model) 
...
R_proposed_tensor,F_predict = AFF_train.inverse(task,trained_model,initial=0, c = 1e-1, n_iter = 10, step_size= 1e-2)   
...
# print('REAL F loss Record', Real_F_loss_record) 
# np.save('saved_model/Design_E_record_sali50.npy', Proposed_h2co) 
