...
R_proposed_tensor,F_predict = AFF_train.inverse(task,trained_model,initial=initial, c = 1e-10, n_iter = 50,random_noise = 1e-4,step_size = 5e-3)   
...
while n_loop<3:
    ...
    R_design_tensor,F_predict=AFF_train.inverse(task,trained_model,initial=initial, c = 1e-10, n_iter = 50,random_noise = 1e-3,step_size = 1e-3)   
