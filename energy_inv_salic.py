...
Record=AFF_train.inverseE_new( task,trained_model,E_target,ind_initial=initial,tol_MAE=0.01,lr=1e-3,c=0.1,num_step = 30,random_val = 1e-2)
#Record=AFF_train.inverseE_new( task,trained_model,E_target,ind_initial=initial,tol_MAE=0.01,lr=1e-3,c=0.001,num_step = 10,random_val = 1e-2)
...
while n_loop<15:
    ...
    initial=n_train
    Record=AFF_train.inverseE_new( task,trained_model,E_target,ind_initial=initial,tol_MAE=0.01,lr=1e-4,c=0.1,num_step = 30,random_val=1e-2 )
