...
R_proposed_tensor,F_predict = AFF_train.inverse(task,trained_model,initial=0, c = 1e-5, n_iter = 250, step_size= 1e-3)   
...
while n_loop<10:
    ...
    R_design_tensor,F_predict=AFF_train.inverse(task,trained_model,initial=initial, c = 1e-5, n_iter = 100,random_noise = 1e-4,step_size=3e-4)   
