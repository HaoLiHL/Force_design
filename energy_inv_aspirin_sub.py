...
Record=AFF_train.inverseE_new( task,trained_model,E_target,ind_initial=initial,tol_MAE=0.01,lr=1e-4,c=1,num_step = 20,random_val = 1e-2)
...
while n_loop<5:
    ...
    Record=AFF_train.inverseE_new( task,trained_model,E_target,ind_initial=initial,tol_MAE=0.01,lr=1e-4,c=1,num_step = 30,random_val = 1e-2)
